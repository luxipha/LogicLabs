#!/usr/bin/env node
/**
 * Transcribes the electric-tractor voiceover with Whisper.cpp to get word-level
...
const INPUT = path.join(
  ROOT,
  'src/assets/electric_tractor/ElevenLabs_2026-09-17T08_50_24_Jane - Professional Audiobook Reader_eleven_v3.mp3',
);
const WAV = path.join(ROOT, '.scratch/electric-tractor-narration-16k.wav');
const OUT = path.join(ROOT, '.scratch/electric-tractor-transcript.json');
