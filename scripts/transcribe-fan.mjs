#!/usr/bin/env node
/**
 * Transcribes the fan voiceover with Whisper.cpp to get word-level
...
const INPUT = path.join(ROOT, 'src/assets/fan/fan.mp3');
const WAV = path.join(ROOT, '.scratch/fan-narration-16k.wav');
const OUT = path.join(ROOT, '.scratch/fan-transcript.json');
