#!/usr/bin/env node
/**
 * Transcribes the kangaroo voiceover with Whisper.cpp to get word-level
...
const INPUT = path.join(
  ROOT,
  'src/assets/Kangaroo/ElevenLabs_2026-09-20T11_55_50_Jane - Professional Audiobook Reader_eleven_v3.mp3',
);
const WAV = path.join(ROOT, '.scratch/kangaroo-narration-16k.wav');
const OUT = path.join(ROOT, '.scratch/kangaroo-transcript.json');
