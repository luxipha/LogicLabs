#!/usr/bin/env node
/**
 * Transcribes the money voiceover with Whisper.cpp to get word-level
...
const INPUT = path.join(ROOT, 'src/assets/money/money.mp3');
const WAV = path.join(ROOT, '.scratch/money-narration-16k.wav');
const OUT = path.join(ROOT, '.scratch/money-transcript.json');
