#!/usr/bin/env node
/**
 * Transcribes the printer voiceover with Whisper.cpp to get word-level
...
const INPUT = path.join(ROOT, 'src/assets/printer/printer.mp3');
const WAV = path.join(ROOT, '.scratch/printer-narration-16k.wav');
const OUT = path.join(ROOT, '.scratch/printer-transcript.json');
