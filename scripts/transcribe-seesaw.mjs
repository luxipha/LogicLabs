#!/usr/bin/env node
/**
 * Transcribes the seesaw voiceover with Whisper.cpp to get word-level
...
const INPUT = path.join(ROOT, 'src/assets/seesaw/seesaw.mp3');
const WAV = path.join(ROOT, '.scratch/seesaw-narration-16k.wav');
const OUT = path.join(ROOT, '.scratch/seesaw-transcript.json');
