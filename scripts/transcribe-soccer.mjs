#!/usr/bin/env node
/**
 * Transcribes the soccer voiceover with Whisper.cpp to get word-level
...
const INPUT = path.join(ROOT, 'src/assets/soccer/enpty goal.mp3');
const WAV = path.join(ROOT, '.scratch/soccer-narration-16k.wav');
const OUT = path.join(ROOT, '.scratch/soccer-transcript.json');
