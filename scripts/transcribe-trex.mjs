#!/usr/bin/env node
/**
 * Transcribes the T-Rex voiceover with Whisper.cpp to get word-level
...
const INPUT = path.join(ROOT, 'src/assets/trex/TREX.mp3');
const WAV = path.join(ROOT, '.scratch/trex-narration-16k.wav');
const OUT = path.join(ROOT, '.scratch/trex-transcript.json');
